...
class CidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cidade" do
    assert_difference('Cidade.count') do
      post cidades_url, params: { cidade: { codibge: @cidade.codibge, estado_id: @cidade.estado_id, nome: @cidade.nome } }, as: :json
    end
  ...
  test "should update cidade" do
    patch cidade_url(@cidade), params: { cidade: { codibge: @cidade.codibge, estado_id: @cidade.estado_id, nome: @cidade.nome } }, as: :json
    assert_response 200
  end
